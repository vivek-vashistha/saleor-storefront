...
2. **Prepare your product data CSV file** in the `backend/data/` directory with the same structure as `saleor_products_ready_enriched.csv`:
...
- The script will create categories, product types, and collections automatically if they don't exist
