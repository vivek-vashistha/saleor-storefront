...
from backend.presentation.api.routes.v1 import chat_router, orders_router, session_router, memory_router, fake_memories_router
...
v1_router.include_router(fake_memories_router, tags=["Fake Memories"])
